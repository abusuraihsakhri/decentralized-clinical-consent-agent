"""
Data Models & Telemetry Definitions for ConsentLedger: Smart Contract Dynamic Patient Data Use Authorization Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "HL7 FHIR Consent Resource & W3C DID"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
