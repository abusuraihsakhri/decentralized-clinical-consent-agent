"""
Automated Pytest for decentralized-clinical-consent-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ConsentAuditTrailEngine,
    ConsentVersionManagementEngine,
    MultilanguageConsentSupportEngine,
    ConsentExpiryRenewalEngine,
    ConsentWithdrawalWorkflowEngine,
    DecentralizedclinicalconsentagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = DecentralizedclinicalconsentagentEnrichmentSuite()
