...
import pytest
from consent_ledger.models import FrontierPayload, ExecutionStatus
from consent_ledger.engine import FrontierDomainEngine
from consent_ledger.agents import ConsentDirectiveValidatorAgent, SignatureIntegrityAgent, RevocationStatusAuditorAgent, ConsentLedgerCoordinator
from consent_ledger.cli import main


def test_sub_agents():
    a1 = ConsentDirectiveValidatorAgent()
    ...
    a3 = RevocationStatusAuditorAgent()
...
def test_coordinator():
    coord = ConsentLedgerCoordinator()
    ...
    assert "HL7 FHIR Consent Resource & W3C DID" in ans or "specifications" in ans
