"""
Pydantic v2 schemas and data definitions for Decentralized Clinical Consent Agent.
...
class SystemTaskPayload(BaseModel):
    ...
    def validate_metric_is_finite(cls, v: float) -> float:
        """Reject NaN and Inf values which could corrupt downstream calculations."""
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "decentralized-clinical-consent-agent"
